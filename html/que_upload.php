                ...
                <form action="submits/question.php" method="post">
                    <div class="form-group" style="width:auto">
                        ...
                        <select class="form-control" name="forum_id" style="width:15rem;">
                            <?php
                            if($forum_id!="")echo '<option value="'.$forum_id.'">'.$category[$forum_id].'</option>';
                            else{
                            ...
                            <option value="1002">Java</option>
                            <option value="1003">Python3</option>
                            <option value="1004">Scratch</option>
                        </select>
                        <br>
